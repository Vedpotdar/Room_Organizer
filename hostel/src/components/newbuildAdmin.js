...
function AdminHostelRoomNEW() {
    ...
    useEffect(() => {
        ...
        const floors = {
            'Ground Floor': { start: 101, end: 125 },
            'First Floor': { start: 201, end: 225 },
            'Second Floor': { start: 301, end: 325 }
        };
    ...
    >
      <Modal.Dialog id='roomDetailBox'>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={partners}>Show Room Partner Details</Button>
...
export default AdminHostelRoomNEW;
